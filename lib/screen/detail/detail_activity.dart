import 'package:ayomakan/screen/update.dart';
...
class _DetailState extends State<Detail> {
          ...
          StreamBuilder<String?>(
            ...
            builder: (context, AsyncSnapshot<String?> userIdSnapshot) {
              ...
              if (userId == recipe['ownerUid']) {
                ...
                return IconButton(
                  onPressed: () {
                    // Aksi yang diambil saat tombol Bookmark ditekan
                    if (kDebugMode) {
                    ...
                    if (userId != null) {
                      if (recipe['bookmarkedBy']?.contains(userId) ?? false) {
                        ...
                        addBookmark(widget.documentId, userId);
                      }
  ...
  void addBookmark(String recipeId, String userId) {
